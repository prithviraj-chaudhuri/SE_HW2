...
class ScriptManager(models.Manager):
    ...
    def get_all_scripts(self):
        raw_results = self.raw("select script_id, script_title, download_link, readme_link, raw_url from scripts")
        results = []
        for raw_result in raw_results:
            ...
            result["readme_link"] = raw_result.readme_link
...
class Scripts(models.Model):
    ...
    readme_link = models.CharField(max_length=500, null=False, default="")
